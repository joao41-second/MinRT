...
void word_test()
{
	...
	check += test_shade_wor_it(4 ,ray_gener(create_point(0, 0, -5), create_vector(0, 0, 1)), c_new(0.380661,0.475826,0.285496),rt);
	start_word_test(&rt,0.1,c_new(1,1,1));
	rt.luz.point = create_point(0, 0.25, 0);
	check += test_shade_wor_it(0.5 ,ray_gener(create_point(0, 0, 0), create_vector(0, 0, 1)), c_new( 0.904984,0.904984,0.904984),rt);
