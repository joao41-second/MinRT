...
/*   Updated: 2025/06/18 09:50:39 by rerodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		parse_sphere(char *line, int fd, t_list_ **objects);
void		parse_plane(char *line, int fd, t_list_ **objects);
void		parse_cylinder(char *line, int fd, t_list_ **objs);
