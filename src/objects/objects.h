...
void					obj_square(t_point *points, t_list_ *word, t_mater mat,
							t_matrix matrix);
...
t_mater					obj_material_init(t_color intensty, t_color pattern,
							t_m_values values, double reflect);

void					obj_material_print(t_mater mat);

t_img_					*obj_creat_texture(t_canva canva, char *img);

t_point					*obj_create_points(t_point p1, t_point p2, t_point p3,
							t_point p4);
