...
/*   Updated: 2025/06/06 11:06:15 by jperpct          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_intersection ray_int_sphere(t_ray ray, t_sphere shp) {
  ...
  a_ = ((ray.direction.x * ray.direction.x) +
...
t_intersection ray_int_plane(t_ray ray, t_plane plane) {
  ...
  a = -(plane.normal.x * ray.origin.x + plane.normal.y * ray.origin.y +
        plane.normal.z * ray.origin.z);
  b = (plane.normal.x * ray.direction.x + plane.normal.y * ray.direction.y +
