...
/*   Updated: 2025/05/23 20:19:24 by rerodrig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	canva_inicializ(t_minirt *rt_struct, int x, int y, t_color base)
{
	...
	// rt_struct->canva.axis_buffer.img = mlx_new_image(rt_struct->canva.mlx, x, y);
	// rt_struct->canva.axis_buffer.addr = mlx_get_data_addr(rt_struct->canva.axis_buffer.img,
	// 	&rt_struct->canva.axis_buffer.bits_per_pixel,
	// 	&rt_struct->canva.axis_buffer.line_length,
	// 	&rt_struct->canva.axis_buffer.endian);
	...
	// mlx_destroy_image(rt_struct->canva.mlx, rt_struct->canva.menu_buffer.img);
	// mlx_destroy_image(rt_struct->canva.mlx, rt_struct->canva.axis_buffer.img);
