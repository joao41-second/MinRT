...
/*   Updated: 2025/03/18 14:09:54 by jperpct          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void canva_inicializ(t_minirt *rt_struct,int x, int y, t_color base)
{
	...
	rt_struct->canva.canva = mlx_new_image(rt_struct->canva.mlx, x, y);
	...
	mlx_destroy_image(rt_struct->canva.mlx,rt_struct->canva.canva);
